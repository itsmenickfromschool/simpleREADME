...
function renderLicenseBadge(license) {
  ...
  if (license === 'MIT') return `[![License: CC0-1.0](https://img.shields.io/badge/License-CC0_1.0-lightgrey.svg)](http://creativecommons.org/publicdomain/zero/1.0/)`
  ...
  if (license === 'GPL v3') return `[![License: GPL v3](https://img.shields.io/badge/License-GPLv3-blue.svg)](https://www.gnu.org/licenses/gpl-3.0)`
  if (license === 'GPL v2') return `[![License: GPL v2](https://img.shields.io/badge/License-GPL_v2-blue.svg)](https://www.gnu.org/licenses/old-licenses/gpl-2.0.en.html)`
...
function generateMarkdown(data) {
  const {readmeTitle, description, installation, usage, credits, license, tests, github, email} = data
  return `# ${readmeTitle}
